...
#define RETRACTION_FULL_EXT_LCRIGHT_TH -16 //20 // threshold for determining RETRACTION to FULL_EXT State right loadcell load
#define RETRACTION_H_STRIKE_LCBACK_TH 100 // threshold for determining RETRACTION to H_STRIKE State for back loadcell load
#define RETRACTION_H_STRIKE_LCBACKFRONT_TH 0 //110 // threshold for determining RETRACTION to H_STRIKE State for back loadcell and front loadcell difference
#define FULLEXT_MIDSTANCE_LCFRONT_TH 50 //0 // threshold for determining sufficient load for front loadcell for Full Extension to Midstance transition
#define FULLEXT_MIDSTANCE_LCBACK_TH -1 //0 // threshold for determining sufficient load for back loadcell for Full Extension to Midstance transition
